    ...
    $.getJSON("mapData.json", function (mapData) {
        ...
        $.getJSON("myGeo.json", function (myGeo) {
            ...
            for (i = 0; i < mapData.length; i++) {
                ...
                NNData.push([{name: mapData[i]['name'], value: 100}, {name: myGeoData['city'] + "," + myGeoData['region'] + "," + myGeoData['country'], value: 80}]);
            }
            
            Destinations.push({name: "You:" + myGeoData['city'] + "," + myGeoData['region'] + "," + myGeoData['country'], value: [myGeoData['ll'][1], myGeoData['ll'][0]]});
            ...
            console.log(NNData.filter(onlyUnique));
